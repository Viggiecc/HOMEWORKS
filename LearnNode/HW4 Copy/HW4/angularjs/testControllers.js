...
// app.controller('editUserCtrl', function($scope, userService) {
//   // $scope.users = userService.users;
//   // var getChoosenUserFromApi = function($routeParams.param) {
//     userService.getUsersById($routeParams.id)
//       .then(function mySuccess(response) {
//         $scope.choosenUser = response.data;
//         showChoosenUser();
//       }, function myError(response){
