...
app.factory('userService', function($http) {
  var userServ = {};
  var baseUrl = 'http://localhost:3030/api/user';
...
app.controller('newUserCtrl', function($scope, userService) {
  ...
  if ($scope.passw1 !== $scope.passw2) {
    ...
    $scope.test = function() {
      ...
      $scope.incomplete = true;
      if ($scope.newfName && $scope.newlName && $scope.newpassw1 && $scope.newpassw2 && $scope.newTitle && $scope.newSex && $scope.newAge) {
...
app.controller('editUserCtrl', function($scope, userService, $routeParams) {
    ...
    var showChoosenUser = function() {
      console.log($scope.choosenUser.newfName);
